...
Configure PE Router
    ...
    # configure untagged dhcp-enabled interfaces (eth1, eth2...) that connects HQ, PA and SJ underlays
...
Configure VSC VM
    ...
    VSC.Execute Command    /bof static-route ${pa_wan_network} next-hop ${pe-router}
    VSC.Execute Command    /bof static-route ${sj_wan_network} next-hop ${pe-router}
    VSC.Execute Command    /bof static-route ${hq_sf_wan_network} next-hop ${pe-router}
