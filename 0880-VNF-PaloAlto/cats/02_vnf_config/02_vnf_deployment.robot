...
*** Test Cases ***
Create VNF for LAN
    ${status}  ${pan_vnf_orig_state} =  Run Keyword And Ignore Error
                                            ...    NuageVNF.Get VNF
                                                   ...    name=${pan_vnf_name} 
...
Create VNF And Attach Mgmt Interface
    ...
    ${vnf_xml} =  Load VNF Blob
                  ...
                  ...    image_url=http://utility.nuage.lab/PA-VM-KVM-8.1.3.qcow2
                  ...    image_md5=414742557ac574bdc8b64739f95d0831
                  ...    iso_url=http://utility.nuage.lab/paloalto.iso
                  ...    iso_md5=569a1acf9241acc23d0a0e583003249c
