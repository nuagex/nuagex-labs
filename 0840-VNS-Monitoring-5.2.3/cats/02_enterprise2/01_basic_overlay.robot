...
Creating Subnets
    ...
    ...    cats_address=${subnet3_network_addr}

    Create Address Range in Subnet
    ...    cats_org_name=${org_name}
    ...    cats_domain_name=${l3domain_name}
    ...    cats_subnet_name=${subnet3_name}
    ...    minAddress=${branch_pc3_data_addr}
    ...    maxAddress=${branch_pc3_data_addr}
    ...
    ...    cats_domain_name=${l3domain_name}
    ...    cats_zone_name=${zone_name}
    ...    cats_address=${subnet4_network_addr}

    Create Address Range in Subnet
    ...    cats_org_name=${org_name}
    ...    cats_domain_name=${l3domain_name}
    ...    cats_subnet_name=${subnet4_name}
    ...    minAddress=${branch_pc4_data_addr}
    ...    maxAddress=${branch_pc4_data_addr}
    ...
    ...    cats_domain_name=${l3domain_name}
    ...    cats_zone_name=${zone_name}
    ...    cats_address=${subnet5_network_addr}

    Create Address Range in Subnet
    ...    cats_org_name=${org_name}
    ...    cats_domain_name=${l3domain_name}
    ...    cats_subnet_name=${subnet5_name}
    ...    minAddress=${branch_pc5_data_addr}
    ...    maxAddress=${branch_pc5_data_addr}
